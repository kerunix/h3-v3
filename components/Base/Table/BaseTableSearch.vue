...
<template>
  <div class="w-full flex items-center ">
    ...
    <BaseTooltip v-if="query" class="ml-4">
      <button class="rounded-full p-1 text-gray-600 hover:bg-gray-300 hover:text-gray-800 dark:text-gray-400 hover:dark:bg-gray-600 hover:dark:text-gray-100" @click="onClearQuery">
