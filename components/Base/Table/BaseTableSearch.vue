...
<template>
  <div class="w-full flex items-center ">
    <div class="relative w-md">
      <SearchIconOutline
        class="pointer-events-none absolute top-3 right-4 h-5 w-5 text-gray-300 z-10"
        aria-hidden="true"
      />
      <input
        v-bind="$attrs"
    ...
    >
      <button
        class="rounded-full p-1 text-gray-600 hover:bg-gray-300 hover:text-gray-800 dark:text-gray-400 hover:dark:bg-gray-600 hover:dark:text-gray-100"
        @click="onClearQuery"
      >
