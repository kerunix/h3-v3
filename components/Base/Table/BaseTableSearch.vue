...
<template>
  <div class="relative max-w-sm">
    ...
    >
    <button v-if="query" class="absolute -right-10 top-2 rounded-full p-1 text-gray-600 hover:bg-gray-300 hover:text-gray-800 dark:text-gray-400 hover:dark:bg-gray-600 hover:dark:text-gray-100" @click="onClearQuery">
